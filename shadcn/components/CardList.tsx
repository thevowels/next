...
import { Content, Transaction } from "@/lib/types";
...
const popularContent: Content[] = [
  ...
  export default function CardList({title}: {title:string}){
	...
	const list : Content[] | Transaction[]  = title === "Popular Content" ? popularContent : latestTransactions;

	return (
		<div className="">
			<h1 className="text-lg font-medium mb-6">{title}</h1>
			<div className="flex flex-col gap-2">
				{list.map((item:Content |Transaction) => (
